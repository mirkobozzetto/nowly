...
export const Switch: FC<Props> = ({ ariaLabel, checked, id, onChange }): React.ReactElement => (
  <button
    ...
    className={`group relative h-4.5 w-9 shrink-0 rounded-lg transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50 focus-visible:ring-offset-1 focus-visible:ring-offset-background ${
      checked
        ? "bg-accent"
