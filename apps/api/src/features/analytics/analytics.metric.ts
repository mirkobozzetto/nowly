export type AnalyticsMetric = {
  ...
  label: string
  description: string
  group: "extension" | "native" | "presence" | "marketplace" | "uninstall" | "settings" | "ratings" | "release"
  private?: boolean
  dimensions: string[]
...
export class Analytics {
  ...
  readonly group: AnalyticsMetric["group"]
...
export const isAnalyticsEventKey = (key: string): boolean => Boolean(getAnalyticsMetric(key))
